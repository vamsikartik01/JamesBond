  ...
  ngOnInit(){
    ...
    this.weatherService.weatherEvent.subscribe(
      (weather: Weather) => {
        ...
        this.infoItems1[0].value = this.weatherData.feels_like+" °C";
        this.infoItems1[1].value = this.weatherData.speed+" km/h";
        this.infoItems1[2].value = this.weatherData.humidity+"%";
        this.infoItems2[0].value = this.weatherData.visibility/1000+" km";
        this.infoItems2[1].value = this.weatherData.pressure+" hpa";
